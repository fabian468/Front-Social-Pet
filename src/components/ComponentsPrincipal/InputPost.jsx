...
function InputPost() {
    ...
    async function handlerSubmit(e) {
        e.preventDefault()
        await createPost(content, image, localStorage.getItem('idUser'))
    ...
    return (
        <form onSubmit={e => handlerSubmit(e)} className='formPost'>
            <textarea value={content} placeholder='¿Tu mascota hizo algo divertido? ¡Compártelo!' type='text' onChange={e => setContent(e.target.value)} />
