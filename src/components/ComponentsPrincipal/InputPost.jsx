...
function InputPost() {
    ...
    async function handlerSubmit(e) {
        ...
        let res = await createPost(content, image, localStorage.getItem('idUser'))
        console.log(res)
    }

    return (
        <form onSubmit={e => handlerSubmit(e)} className='formPost'>
            <textarea placeholder='¿Tu mascota hizo algo divertido? ¡Compártelo!' type='text' onChange={e => setContent(e.target.value)} />
